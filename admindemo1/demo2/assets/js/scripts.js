...
! function(u, p) {
    ...
    u.ClassBody = function() {
        ...
        var a = "",
            ...
            o = n ? f(o, n) : o;
        o.position = o.position ? "toast-" + o.position : "toast-bottom-right", o.icon = "auto" === o.icon ? i : o.icon || "", o.ui = o.ui ? " " + o.ui : "", a = "" !== o.icon ? '<span class="toastr-icon"><em class="icon ' + o.icon + '"></em></span>' : "", "" !== (t = "" !== t ? a + '<div class="toastr-text">' + t + "</div>" : "") && (!0 === o.clear && toastr.clear(), a = {
            closeButton: !0,
            debug: !1,
            newestOnTop: !1,
            progressBar: !1,
        ...
        }, toastr.options = f(a, o), toastr[e](t))
